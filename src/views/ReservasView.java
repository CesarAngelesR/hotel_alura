...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		lblTitulo.setBounds(68, 61, 256, 42);
		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				calcularValor(txtFechaEntrada,txtFechaSalida);//Activa el evento, después del usuario seleccionar las fechas se debe calcular el valor de la reserva
			}
		});
		...
		txtValor.setBounds(78, 328, 154, 33);
