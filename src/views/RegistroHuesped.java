...
/*	private void guardarHuesped() {
		String FechaN = ((JTextField)txtFechaN.getDateEditor().getUiComponent()).getText();
		Huespedes nuevoHuesped = new Huespedes(txtNombre.toString(), txtApellido.toString(),java.sql.Date.valueOf(FechaN),txtNacionalidad.getSelectedItem().toString(),txtTelefono.toString(),txtNreserva.toString());
